...
export interface AgentMessageResponse {
  content?: string;  // Campo retornado pelo backend Python
  response?: string; // Campo esperado pelo frontend (fallback)
  model_used?: string;
  provider?: string;
  ...
  timestamp?: string; // Campo adicional do backend
  session_id?: string; // Campo adicional do backend
}
