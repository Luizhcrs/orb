...
public partial class App : System.Windows.Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        // Carregar configurações de ambiente (se existirem)
        Config.AppSettings.LoadFromEnvironment();
        
        // Validar configurações
        if (!Config.AppSettings.Validate())
        {
            System.Windows.MessageBox.Show(
                "Erro nas configurações da aplicação. Verifique os logs.",
